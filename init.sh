...
SSH_PUB_KEYS=(
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHIPOMNzeM+dLIZmcv7GDXRAah22V3yozsEL+eHCfyGj proxy"
)
...
echo -e "1. НЕ ЗАКРЫВАЙ эту консоль прямо сейчас."
echo -e "2. Открой НОВУЮ вкладку терминала и проверь подключение:"
echo -e "   ${CYAN}ssh -p $SSH_PORT $NEW_USER@<IP_СЕРВЕРА>${NC}"
echo -e "3. Если вход успешен — перезагрузи сервер командой ${CYAN}reboot${NC}."
echo -e "4. Лог-файл установки сохранен по пути: ${CYAN}$FINAL_LOG${NC}"
echo -e "========================================================================\n"
